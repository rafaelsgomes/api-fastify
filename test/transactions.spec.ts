...
describe('Transactions Routes', () => {
  ...
  it('Should be able to list all transactions', async () => {
    ...
    const listTransactionRoutes = await request(app.server)
      .get('/transactions')
      .set('Cookie', cookies)
      .expect(200)

    expect(listTransactionRoutes.body.transactions).toEqual([
  ...
  it('Should be able to get a specific transactions', async () => {
    ...
    const transactionId = listTransactionRoutes.body.transactions[0].id
